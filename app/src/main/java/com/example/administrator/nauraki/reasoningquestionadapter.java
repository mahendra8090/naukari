...
public class reasoningquestionadapter extends RecyclerView.Adapter<reasoningquestionadapter.ViewHolder> {
    ...
    public reasoningquestionadapter(Context c, String key) {
        Json_reasoning j=new Json_reasoning();
       math= j.getJSon1_titledata_reasoning(c,key);
        st1=math.get(0);
        st2=math.get(1);
        st3=math.get(2);
        st4=math.get(3);
